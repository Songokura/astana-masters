...
(function () {
  ...
  var I18N = {
    ru: {
      ...
      g1: 'Конвекторы у панорамных окон', g2: 'Коллектор тёплого пола', g3: 'Сборка теплового пункта',
      g4: 'Дизайн-радиатор по лазеру', g5: 'Внутрипольный конвектор', g6: 'Разводка отопления в полу',
      g7: 'Установка радиатора', g8: 'Инсталляция и коллектор санузла', g9: 'Замена обвязки котла',
      g10: 'Обвязка котла Viessmann', g11: 'Мастер на объекте', g12: 'Комнатная автоматика',
    ...
    kk: {
      ...
      g1: 'Панорамалық терезедегі конвекторлар', g2: 'Жылы еден коллекторы', g3: 'Жылу пунктін құрастыру',
      g4: 'Лазермен орнатылған дизайн-радиатор', g5: 'Еденге орнатылатын конвектор', g6: 'Еден астындағы жылу құбырлары',
      g7: 'Радиатор орнату', g8: 'Инсталляция және санторап коллекторы', g9: 'Қазан байламын ауыстыру',
      g10: 'Viessmann қазанының байламы', g11: 'Нысандағы шебер', g12: 'Бөлме автоматикасы',
