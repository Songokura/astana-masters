...
(function () {
  ...
  var I18N = {
    ru: {
      ...
      hero_shot_t: 'Тепловой пункт под ключ', hero_shot_s: 'сборка, обвязка, балансировка',
    ...
    kk: {
      ...
      hero_shot_t: 'Жылу пункті кілт тапсырыспен', hero_shot_s: 'құрастыру, байлау, теңгеру',
